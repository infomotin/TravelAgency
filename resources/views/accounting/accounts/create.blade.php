    ...
    <div class="card-body">
        <form action="{{ route('accounts.store') }}" method="post" class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="code" value="{{ old('code') }}" class="form-control form-control-sm @error('code') is-invalid @enderror">
                @error('code')
            ...
            <div class="col-md-4">
                ...
                <input type="number" step="0.01" name="opening_balance" value="{{ old('opening_balance', 0) }}" class="form-control form-control-sm @error('opening_balance') is-invalid @enderror">
            ...
            <div class="col-12">
                ...
                <textarea name="description" rows="3" class="form-control form-control-sm @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-12 text-end">
                <button class="btn btn-primary btn-sm">Save Account</button>
            </div>
        </form>
    </div>
</div>
