            ...
            <div class="card p-3 border-top-0 rounded-0 rounded-bottom">
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input name="employee_code" class="form-control" value="{{ old('employee_code') }}" required>
                    </div>
                    <div class="col-md-5">
            ...
            <div class="card p-3 border-top-0 rounded-0 rounded-bottom">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input name="nid" class="form-control" value="{{ old('nid') }}">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card p-3 border-top-0 rounded-0 rounded-bottom">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input name="emergency_contact_name" class="form-control" value="{{ old('emergency_contact_name') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Contact Phone</label>
                        <input name="emergency_contact_phone" class="form-control" value="{{ old('emergency_contact_phone') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Relation</label>
                        <input name="emergency_contact_relation" class="form-control" value="{{ old('emergency_contact_relation') }}">
                    </div>
                </div>
            </div>
        </div>
